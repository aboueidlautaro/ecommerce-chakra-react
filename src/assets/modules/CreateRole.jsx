...
function CreateRole() {
  ...
  const onSubmit = (data) => {
    ...
    try {
      axios.post(createRole, data).then((response) => {
        setError(false);
  ...
  const validationSchema = Yup.object().shape({
    name: Yup.string().required("Introduzca un nombre para el rol"),
  });
        ...
        >
          <Form id="form">
            ...
            >
              ...
              <Field name="name" placeholder="Ingresar rol" />
              <ErrorForm name="name" />
